        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <select name="designation" id="designation" class="form-control">
                    <option value="<?php echo $teacher->designation ?>" selected  ><?php echo $teacher->designation ?></option>
            ...
            <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="price" class="col-sm-2 control-label">
                            <?=$this->lang->line("teacher_price")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="price" name="price" value="<?=set_value('price', $teacher->price)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        <label for="about" class="col-sm-2 control-label">
                            <?=$this->lang->line("teacher_about")?>
                        </label>
                        <div class="col-sm-6">
                            <textarea class="form-control" id="about" name="about"><?=set_value('about', $teacher->about)?></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
