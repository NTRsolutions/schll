            ...
            <div class="add--page--wrap">
                ...
                <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                    ...
                    <div class="permalink-area" <?=($send_url['status']) ? 'style="display:block"' : 'style="display:none"' ?>>
                        ...
                        <span class="permalink"><?=base_url()?><span class="editable-permalink-name"><?=($send_url['status']) ? $send_url['url'] : '' ?></span><input id="url" name="url" class="url" type="text" value="<?=($send_url['status']) ? $send_url['url'] : '' ?>" style="display: none" ></span>
