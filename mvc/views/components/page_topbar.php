                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">
                            <a target="_blank" href="<?=base_url('frontend/page')?>" class="dropdown-toggle" data-toggle="tooltip" title="<?=$this->lang->line('menu_visit_site')?>" data-placement="bottom">
...
<!--                                <li class="header">-->
<!--                                    <?//$this->lang->line("language")?> --> <!-- orginal - < ?=//$this->lang->line("language")? >-->
<!--                                </li>-->
<!--                                <li>-->
