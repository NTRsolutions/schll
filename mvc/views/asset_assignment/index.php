                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class=""><?=$this->lang->line('assigned_quantity')?></th>
                                <th class=""><?=$this->lang->line('asset_assignment_usertypeID')?></th>
                                <th class=""><?=$this->lang->line('asset_assignment_check_out_to')?></th>
                                <th class=""><?=$this->lang->line('due_date')?></th>
                                <th class=""><?=$this->lang->line('check_out_date')?></th>
                                <th class=""><?=$this->lang->line('check_in_date')?></th>
                                <th class=""><?=$this->lang->line('status')?></th>
                        ...
                        <tbody>
                            <?php if(count($asset_assignments)) {$i = 1; foreach($asset_assignments as $asset_assignment) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('assigned_quantity')?>">
